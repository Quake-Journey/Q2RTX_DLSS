...
#define LIST_SHADER_MODULES \
	...
	SHADER_MODULE_DO(QVK_MOD_DLSS_RR_PREP_COMP)                      \
...
typedef struct QVK_s {
	...
	int32_t                     queue_idx_optical_flow;
	uint32_t                    sl_graphics_queue_index;
	uint32_t                    sl_compute_queue_index;
	uint32_t                    sl_optical_flow_queue_index;
	bool                        sl_use_native_optical_flow;
	VkSurfaceKHR                surface;
	VkSwapchainKHR              swap_chain;
	VkSurfaceFormatKHR          surf_format;
	bool                        surf_is_hdr;
	bool                        surf_vsync;
	bool                        surf_mfg_enabled;
...
VkResult vkpt_final_blit_view(VkCommandBuffer cmd_buf, VkImageView src_view, VkExtent2D extent, bool filtered, bool warped);
