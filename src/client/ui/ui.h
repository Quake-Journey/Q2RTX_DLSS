...
typedef struct menuFrameWork_s {
	...
	menuCondition_t current_conditions[MAX_MENU_CONDITIONS];
	int num_current_conditions;
...
typedef struct menuCommon_s {
	...
	menuCondition_t conditions[MAX_MENU_CONDITIONS];
	int num_conditions;
